...
public class UpcomingDramaAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    private List<UpcomingModel> items;
    public int number = 1;

    public UpcomingDramaAdapter(Context context, List<UpcomingModel> items) {
